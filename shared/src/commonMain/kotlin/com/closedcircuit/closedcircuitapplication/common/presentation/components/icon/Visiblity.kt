package com.closedcircuit.closedcircuitapplication.common.presentation.components.icon
    ...
    return remember {
        ImageVector.Builder(
            ...
            path(
                fill = null,
                fillAlpha = 1.0f,
                stroke = SolidColor(Color(0xFF8A8A8E)),
                strokeAlpha = 1.0f,
                ...
                moveTo(4.5f, 8f)
                curveTo(7.5f, 14.5f, 16.5f, 14.5f, 19.5f, 8f)
            }
            path(
                fill = null,
                fillAlpha = 1.0f,
                ...
                moveTo(16.8164f, 11.3164f)
                lineTo(19.5004f, 14.9984f)
            }
            path(
                fill = null,
                fillAlpha = 1.0f,
            ...
            path(
                ...
                moveTo(7.184f, 11.3164f)
                lineTo(4.5f, 14.9984f)
            }
        }.build()
    }
}